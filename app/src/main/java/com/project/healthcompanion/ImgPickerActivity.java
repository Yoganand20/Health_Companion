...
public class ImgPickerActivity extends AppCompatActivity {
    private static final String TAG = ImgPickerActivity.class.getSimpleName();
    ...
    public static void showImagePickerOptions(Personal_Info context, PickerOptionListener listener) {
    ...
    private Uri getCacheImagePath(String fileName) {
        ...
        return getUriForFile(ImgPickerActivity.this, getPackageName() + ".provider", image);
    }
     ...
     * @param
     */
    public static void clearCache(Personal_Info context) {
        File path = new File(context.requireContext().getExternalCacheDir(), "camera");
