...
public class DashSnacksDispAdapter extends ArrayAdapter<String> {

    ArrayList<String> list;
    Context context;

    public DashSnacksDispAdapter(Context context, ArrayList<String> items) {
        ...
        if(convertView == null) {
            ...
            remove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    DashSnacksFragment.removeDashSnacks(position, BFoodNam);
                }
            });
        }
        return convertView;
