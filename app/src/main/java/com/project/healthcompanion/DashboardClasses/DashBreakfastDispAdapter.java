...
public class DashBreakfastDispAdapter extends ArrayAdapter<String> {

    ArrayList<String> list;
    Context context;

    public DashBreakfastDispAdapter(Context context, ArrayList<String> items) {
        ...
        if(convertView == null) {
            ...
            remove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    DashBreakfastFragment.removeDashBreakfast(position, BFoodNam);
                }
            });
        }
        return convertView;
