...
public class DashLunchDispAdapter extends ArrayAdapter<String>  {

    ArrayList<String> list;
    Context context;

    public  DashLunchDispAdapter(Context context, ArrayList<String> items) {
        ...
        if(convertView == null) {
            ...
            remove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    com.project.healthcompanion.DashboardClasses.DashLunchFragment.removeDashLunch(position, BFoodNam);
                }
            });
        }
        return convertView;
